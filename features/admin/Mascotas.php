...
<head>
    ...
    <style>
        ...
        .estado-dot.activo{ background:#198754; }
        .estado-dot.inactivo{ background:#6c757d; }

        .btn-accion{ cursor:pointer; }
            ...
            <div class="section-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                ...
                <div class="d-flex gap-2 align-items-center flex-wrap">
                    <span class="badge bg-secondary">
                        <?= (int)$totalMascotas; ?> registro(s)
                    </span>

                    <?php if ($totalMascotas > 0): ?>
                        <span class="badge bg-success-subtle text-success">Pequeñas: <?= (int)$totPequeno; ?></span>
                        <span class="badge bg-info-subtle text-info">Medianas: <?= (int)$totMediano; ?></span>
                        <span class="badge bg-warning-subtle text-warning">Grandes: <?= (int)$totGrande; ?></span>
                    <?php endif; ?>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                <?php foreach ($mascotas as $m): ?>
                                    ...
                                    if (!in_array($estadoMascota, ['activo', 'inactivo'], true)) $estadoMascota = 'activo';
