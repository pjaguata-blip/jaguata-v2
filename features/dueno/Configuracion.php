...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $dueno['zona']           = trim($_POST['zona'] ?? '');
    $dueno['notificaciones'] = isset($_POST['notificaciones']);
    ...
    if ($dueno['email'] === '' || !filter_var($dueno['email'], FILTER_VALIDATE_EMAIL)) {
...
<head>
    ...
    <title>Configuración - Dueño | Jaguata</title>
