...
// ---- Filtrar por CANCELADOS + filtros de fecha y texto ----
            ...
            <main class="col-md-12 col-lg-12 px-md-4">
                <div class="d-flex justify-content-between align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <h1 class="h2 mb-0"><i class="fas fa-times-circle me-2"></i>Paseos Cancelados</h1>
                    </div>
                    <a class="btn btn-outline-secondary btn-sm" href="ExportarDashboard.php?estado=cancelado">
                                ...
                                <table class="table table-bordered table-sm align-middle mb-0" style="white-space:nowrap;">
                                    ...
                                    <tbody>
                                        <?php foreach ($paseos as $p): ?>
                                            ...
                                            // En cancelados: normalmente no hay acción
                                            ?>
                                            <tr>
