...
$paseos = array_values(array_filter($soloDueno, function ($p) use ($q, $tsDesde, $tsHasta) {
    ...
    if (!in_array($estado, ['pendiente', 'solicitado', 'confirmado'], true)) return false;
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 d-md-block sidebar">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li><a class="nav-link active" href="#"><i class="fas fa-walking me-2"></i>Paseos Pendientes</a></li>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="page-header">
                    <h1><i class="fas fa-walking me-2"></i>Paseos Pendientes</h1>
                    <a href="ExportarDashboard.php?estado=pendiente" class="btn btn-light btn-sm">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($puedePagar): ?>
                                                        <a href="pago_paseo_dueno.php?paseo_id=<?= (int)$p['paseo_id'] ?>" class="btn btn-sm btn-outline-success shadow-sm">
