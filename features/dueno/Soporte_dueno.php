...
function clsEstado(string $estado): string
{
    ...
    return $e === 'pendiente' ? 'warning' : ($e === 'en progreso' ? 'info' : ($e === 'resuelto' ? 'success' : 'secondary'));
}

/* Tickets (simulado; reemplazar por consulta real) — SOLO del dueño */
$tickets = [
    ['id' => 101, 'asunto' => 'Problema al pagar paseo', 'mensaje' => 'No pude completar el pago.', 'estado' => 'Pendiente', 'respuesta' => null, 'fecha' => '2025-11-02 14:30:00'],
    ['id' => 102, 'asunto' => 'Reembolso', 'mensaje' => 'Solicito revisión del cobro.', 'estado' => 'En progreso', 'respuesta' => 'Estamos revisando con el área de pagos.', 'fecha' => '2025-10-31 10:05:00'],
    ['id' => 103, 'asunto' => 'Sugerencia', 'mensaje' => 'Agregar método de pago adicional.', 'estado' => 'Resuelto', 'respuesta' => 'Lo consideraremos para próximas versiones.', 'fecha' => '2025-10-25 09:00:00'],
];

/* Alta de ticket (simulada) */
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['action'] ?? '') === 'crearTicket') {
    $_SESSION['success'] = 'Tu ticket fue enviado. ✅';
    header('Location: Soporte_dueno.php');
    exit;
}
?>
<!DOCTYPE html>
...
<head>
    <meta charset="UTF-8">
    <title>Soporte - Dueño | Jaguata</title>
...
<body>
    ...
    <main>
        <!-- Encabezado consistente con el resto de pantallas -->
        <div class="page-header">
            <h1 class="h4 m-0"><i class="fas fa-headset me-2"></i>Soporte (Dueño)</h1>
            ...
            <div class="card-body">
                <form method="post" class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="asunto" class="form-control" placeholder="Ej.: Problema con el pago" required>
                    </div>
                    <div class="col-12">
