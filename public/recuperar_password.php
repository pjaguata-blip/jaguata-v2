    ...
    <main class="auth-shell">
        <div class="row g-0 auth-card">
            ...
            <div class="col-lg-6 illustration">
                <div>
                    <span class="illustration-pill"><i class="fa-solid fa-paw"></i> Recuperación</span>
                    <h2 class="illustration-title">Recuperá tu acceso en minutos</h2>
            ...
            <div class="col-lg-6">
                <div class="form-pane">
                    ...
                    <form method="POST" action="<?= AppConfig::getBaseUrl(); ?>/public/enviar_reset.php" autocomplete="off">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" class="form-control" required autocomplete="off" placeholder="tu@email.com">
                        </div>
                        ...
                        <div class="my-4 paw-divider">
                            ...
                            <span class="small">Jaguata • caminemos</span>
                            <i class="fa-solid fa-bone"></i>
                        </div>

                        <div class="d-flex justify-content-between">
                            <a href="<?= AppConfig::getBaseUrl(); ?>/login.php">Volver al login</a>
                            <a href="<?= AppConfig::getBaseUrl(); ?>/registro.php" class="fw-semibold">Crear cuenta</a>
                        </div>
                    </form>
