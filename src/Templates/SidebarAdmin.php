...
$usuarioSesionNombre = Session::getUsuarioNombre() ?? 'Administrador';
$rolSesion           = Session::getUsuarioRol() ?? 'admin';
$baseFeatures        = BASE_URL . "/features/{$rolSesion}";
  ...
  <div class="sidebar-inner">
    ...
    <div class="text-center px-3 mb-3 pt-3">
      ...
      <h6 class="text-white fw-semibold mb-0">
        Hola, <?= htmlspecialchars($usuarioSesionNombre, ENT_QUOTES, 'UTF-8'); ?> 👋
      </h6>
      ...
      <ul class="nav nav-pills flex-column mb-auto px-2" id="sidebarMenu">
        ...
        <li class="nav-item">
          <a href="<?= $baseFeatures; ?>/SuscripcionesPendientes.php"
            ...
            <i class="fas fa-file-invoice-dollar me-2"></i>Suscripciones
          </a>
        </li>
